 ...
 */
mf.TableTwo = function (domStr, option) {
    // --------------------------------------------------------------------
    //                            private
    // --------------------------------------------------------------------
    var self = this, rowsData, lang, $table, $thead, $tbody, $wrapper, $searchBar, defaultOption,
        ...
        isAdding = false, isEditing = false, records = [], isLoadData = true, columnWidth = 0;
    // --------------------------------------------------------------------
   ...
   */
    ...
    */
    ...
    this.loadData = function (searchData, isRemainRecord) {
        if (!finishEditing()) {
            return false;
        }
