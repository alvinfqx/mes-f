...
var viewModel = function () {
    ...
    var table = new mf.Table("#INF00015Table", {
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                type: 'get',
                url: '/MES/api/IntelligentParameter/Inf00015GetGroupList',
                data: searchData,
        ...
        fn_saveData: function (saveData, success) {
            ...
            mf.ajax({
                type: 'Post',
                url: '/MES/api/IntelligentParameter/Inf00015GroupSave',
        ...
        fn_realDelete: function (rowData, success) {
            mf.ajax({
                type: 'Post',
                url: '/MES/api/IntelligentParameter/Inf00015GroupDelete',
        ...
        columns: [
            {
                field: 'Code', title: fields.SourceGroupNumber, align: "center", require: true, width: "120",
                rander: new mf.WirteOnceOnlyRander(new mf.TextRander({ size: 9, maxLength: 20, title: true })),
                checkers: [
                    new mf.TextNotEmptyChecker(fields.SourceGroupNumberIsNull)
                ],
            },
            {
                field: 'Name', title: fields.SourceGroupDescription, require: true, align: "center", width: "154",
                rander: new mf.TextRander({ size: 15, maxLength: 60, title: true }),
                checkers: [
                    new mf.TextNotEmptyChecker(fields.SourceGroupDescriptionIsNull)
                ],
            },
            {
    ...
    this.languagesClick = function () {
        ...
        var columns = [
            {
                field: 'Code', title: fields.SourceGroupNumber,
                halign: 'center', align: 'center', width: "150", require: true
            },
            {
                field: 'Name', title: fields.SourceGroupDescription,
                halign: 'center', align: 'center', width: "150", require: true
            },
            {
        ...
        var parameters = {
            parentUrl: "/MES/IntelligentParameters/INF00015SourceGroup",
            parentMID: "MID",
            tableID: "32",
    ...
    this.exportClick = function () {
        ...
        table.loadDataBack(null, function () {
            ...
            var exportUrl = mf.domain + '/MES/api/ExportFile/Inf00015GroupExport?Token=' + token;
    ...
    this.importClick = function () {
        ...
        $("#BtnImport").click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: window.top.mf.domain + '/MES/api/ImportFile/Inf00015GroupImport',
                data: formdata,
                contentType: false,
                processData: false,
...
var arrayWord = [
    ...
    "SourceGroupNumber", "SourceGroupDescription", "Remark", "Status", "CreatedBy", "CreatedDate",
    ...
    "SourceGroupNumberIsNull", "SourceGroupDescriptionIsNull"
];
