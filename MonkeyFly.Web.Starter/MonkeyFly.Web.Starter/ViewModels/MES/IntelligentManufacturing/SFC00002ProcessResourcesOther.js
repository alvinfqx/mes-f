...
var viewModel = function () {
    ...
    var MainTable = new mf.Table("#MainTable", {
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                type: 'get',
                url: '/MES/api/IntelligentManufacturing/Sfc00002GetFabMoResourceOther',
                data: searchData,
                success: function (data) {
                    success(data);
                }
        ...
        fn_saveData: function (saveData, success) {
            ...
            for (var i = 0, length = saveData.inserted.length; i < length; i++) {
                ...
                saveData.inserted[i].Type = "0201213000086";
        ...
        columns: [
            ...
            },           
            {
                ...
                fn_onEditingChange: function (table, $row, $cell, field, e) {
                    ...
                    $("#ClassName").attr("title", e.data.ClassName);
                },
                checkers: [
                ...
                fn_onEditingChange: function (self, $row, $cell, field, e, rowsData) {
                    if ($cell.prop("checked") && rowsData.length > 1) {
                        for (var i = 0; i < rowsData.length; i++) {
                            if ($row.data("index") != i) {
                                MainTable.updateCellValue(i, 6, field, 0);
                            }
                        }
                    }
                }
...
var arrayWord = [
    ...
    "ResourcesIsNull", "ResourceMasterFile", "SourceDetail", "SourceClass", "OrderNum", "SequenceNo",
