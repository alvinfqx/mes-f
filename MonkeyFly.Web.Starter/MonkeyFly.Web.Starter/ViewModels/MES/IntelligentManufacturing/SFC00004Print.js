var viewModel = function () {
    ...
    this.backClick = function () {
        ...
        window.top.page_parameters.Caching.push({ URL: parameters.parentUrl, Parameters: parameter });
    ...
    mf.ajax({
        ...
        data: ({ TaskDispatchID: parameters.TaskDispatchID }),
        success: function (data) {
            $("#items").html('&nbsp;&nbsp;&nbsp;<span style="width:43%; display: inline-block; text-align: left;">' + fields.TaskCardNo + '：' + data.TaskNo + '</span><span class="title3">' + fields.StartWorkD + '：' + mf.format.Date(data.StartDate) + '</span><span class="title3">' + fields.EndWorkD + '：' + "" + '</span>');
            $("#MoNo").text(data.MoNo);
...
var parameters = window.top.page_parameters.GetParameters("/MES/IntelligentManufacturing/SFC00004Print");
