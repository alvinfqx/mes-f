...
var viewModel = function () {
    ...
    var MainTable = new mf.Table("#MainTable", {
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                type: 'get',
                url: '/MES/api/IntelligentManufacturing/Sfc00001GetLResourceList',
                data: searchData,
                success: function (data) {
                    success(data);
                }
        ...
        fn_saveData: function (saveData, success) {
            ...
            mf.ajax({
                type: 'Post',
                url: '/MES/api/IntelligentManufacturing/Sfc00001LResourceSave',
...
var arrayWord = [
    ...
    "ResourcesIsNull", "ResourceMasterFile", "WorkNumber", "Name", "SourceDescription", "SourceDescription"
];
