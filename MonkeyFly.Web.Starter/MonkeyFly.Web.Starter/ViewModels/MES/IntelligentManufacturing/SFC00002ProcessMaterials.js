var URL = "/MES/IntelligentManufacturing/SFC00002ProcessMaterials";
...
var viewModel = function () {
    ...
    var MainTable = new mf.Table("#MainTable", {
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                type: 'get',
                url: '/MES/api/IntelligentManufacturing/Sfc00002GetFabMoItem',
                data: searchData,
                success: function (data) {
                    success(data);
                }
        ...
        fn_saveData: function (saveData, success) {
            ...
            for (var i = 0, length = saveData.inserted.length; i < length; i++) {
                ...
                saveData.inserted[i].Status = mf.systemID + "0201213000001";
            };
            for (var i = 0, length = saveData.updated.length; i < length; i++) {
                saveData.updated[i].FabMoProcessID = mainForm.FabMoProcessID;
                saveData.updated[i].Status = mf.systemID + "0201213000001";
            }

            mf.ajax({
                type: 'Post',
                url: '/MES/api/IntelligentManufacturing/Sfc00002SaveFabMoItem',
        ...
        fn_realDelete: function (rowData) {
            var deleteData = {};
            deleteData.FabMoItemID = rowData.FabMoItemID;
            mf.ajax({
                type: 'Post',
                url: '/MES/api/IntelligentManufacturing/Sfc00002FabMoItemDelete',
        ...
        columns: [
            ...
            },
            {
             ...
             {
                 field: 'Status', title: "", visible: false,
                 rander: new mf.TextRander()
             },
            {
...
var arrayWord = [
    ...
    "BasicQuantityIsMaxDecimal", "AttritionRateIsNonNegativeNumber", "AttritionRateIsMaxInteger","HadMaterial",
    "AttritionRateIsMaxDecimal", "OrderNum", "SequenceNo", "Qty", "ManufacturingUnit", "WhetherToDelete", "ItemIsNull", "info"
];
