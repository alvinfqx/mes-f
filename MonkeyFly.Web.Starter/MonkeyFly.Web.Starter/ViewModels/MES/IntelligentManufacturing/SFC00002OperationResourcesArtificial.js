...
var viewModel = function () {
    ...
    var MainTable = new mf.Table("#MainTable", {
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                type: 'get',
                url: '/MES/api/IntelligentManufacturing/Sfc00002GetFabMoOperationLResource',
                data: searchData,
                success: function (data) {
                    success(data);
                }
...
var arrayWord = [
    ...
    "ResourcesIsNull", "ResourceMasterFile", "WorkNumber", "Name", "OrderNum", "SequenceNo","info",
    "Qty", "ManufacturingUnit"
];
