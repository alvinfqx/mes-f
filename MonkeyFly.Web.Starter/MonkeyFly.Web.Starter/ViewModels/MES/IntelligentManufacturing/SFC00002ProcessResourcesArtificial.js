...
var viewModel = function () {
    ...
    var ResourcesTable = new mf.Table("#ResourcesTable", {
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                type: 'get',
                url: '/MES/api/PopUp/Sfc00001GetLGroupList',
                data: {
                    WorkCenterID: mainForm.WorkCenterID,
                    GroupCode: GroupCode,
    ...
    var MainTable = new mf.Table("#MainTable", {
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                type: 'get',
                url: '/MES/api/IntelligentManufacturing/Sfc00002GetFabMoResourceUser',
                data: searchData,
                success: function (data) {
                    success(data);
                }
        ...
        fn_saveData: function (saveData, success) {
            ...
            for (var i = 0, length = saveData.inserted.length; i < length; i++) {
                ...
                saveData.inserted[i].Type = "0201213000085";
        ...
        columns: [
            ...
            {
                field: 'ResourceName', title: fields.NameSpecification, align: "center", width: "140",
    ...
    var DetailTable = new mf.Table("#DetailTable", {
        ...
        columns: [
            {
                field: 'DetailCode', title: fields.WorkNumber, align: "center", require: true, width: "130",
                rander: new mf.WirteOnceOnlyRander(new mf.TextRander({ size: 10, maxLength: 20, title: true }))
            },
            {
                field: 'DetailName', title: fields.Name, require: true, align: "center", width: "130",
                rander: new mf.WirteOnceOnlyRander(new mf.TextRander({ size: 16, maxLength: 60, title: true }))
            },
            {
...
var arrayWord = [
    ...
    "ResourcesIsNull", "ResourceMasterFile", "WorkNumber", "Name", "OrderNum", "SequenceNo",
