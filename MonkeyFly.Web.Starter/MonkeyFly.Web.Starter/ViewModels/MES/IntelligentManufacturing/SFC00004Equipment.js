var viewModel = function () {
    ...
    this.refreshClick = function () {
        table.goForword(function () {
            ...
            window.location.href = '/MES/IntelligentManufacturing/SFC00004Equipment';
        }, function () {
            window.top.page_parameters.Caching.push({ URL: "/MES/IntelligentManufacturing/SFC00004Resources", Parameters: parameters });
            window.location.href = '/MES/IntelligentManufacturing/SFC00004Equipment';
        }, fields.Isleave);
    ...
    //设置设备資源明細表格
    var table = new mf.Table("#EquipmentTable", {
        uniqueId: "TaskDispatchResourceID",
        editable: true,
        LastWidth: "219",
        ...
        fn_getData: function (pagination, searchData, success) {
            ...
            mf.ajax({
                ...
                data: ({ page: pagination.page, rows: pagination.rows, TaskDispatchID: rowData.TaskDispatchID, Type: mf.systemID + "0201213000084" }),
                success: function (data) {
                    //alert(JSON.stringify(data));
                    success(data);
                }
        ...
        columns: [
            ...
            {
                field: 'EquipmentCode', title: fields.EquipmentCode, align: "center", width: "200", require: true,
            ...
            {
                field: 'EquipmentName', title: fields.EquipmentName, align: "center", width: "200",
                rander: new mf.TextRander({ size: 24,  title: "title", disabled: "disabled" }),
            },
            {
...
var URL = "/MES/IntelligentManufacturing/SFC00004Equipment";

var MID = window.top.page_parameters.GetParameters(URL);

var arrayWord = [
    "Refresh", "Search", "Save", "New", "Change", "Deletion", "Cancel", "Add", "TaskCardNo",
    "EquipmentCode", "EquipmentName", "SourceCode", "MainResource", "SourceClass",
    "EquipmentCodeIsNull", "yes", "no", "Comfirm", "EquipmentInformation", "Equipment",
    "IsDelete", "info"
];
